...
func NewFunctionSymbol(name string, signature TypedFunctionSignature, isPublic bool) FunctionSymbol {
...
func NewDependentlyTypedFunctionSymbol(name string, flags FuncSymbolFlags, isPublic bool) DependentlyTypedFunctionSymbol {
