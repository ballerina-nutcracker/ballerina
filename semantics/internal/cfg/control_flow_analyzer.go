...
// lambdaCFG pairs an anonymous function with its graph. Unlike named functions
// these are not reachable from any package level declaration list, so they are
// held as pairs rather than keyed by symbol.
