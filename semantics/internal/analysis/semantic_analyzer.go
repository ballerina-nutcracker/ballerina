...
// Analyze runs semantic analysis over pkg, resolving references into imported modules
// through importedSymbols and reporting diagnostics to ctx.
...
// analyze binds the analyzer to pkg, collects module-level variable metadata, validates the
// module-level isolated declarations and then walks the package.
