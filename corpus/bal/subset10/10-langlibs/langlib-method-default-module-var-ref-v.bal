...
// The receiver is an inferred module-level var, so its type has to come from
// the initializer before the langlib method in the default can be looked up.
function initial(string s = greeting.substring(0, 2)) returns string {
    return s;
}
