...
function rhsOnly(typedesc T = <>) returns error|T[] = external;
function bothSides(typedesc T = <>) returns T[]|T = external;
function bothIntersect(typedesc T = <>) returns T[] & T = external;
function outsideIntersection(typedesc T = <>) returns T[] & readonly = external;
function rhsFails(typedesc T = <>) returns T & T[] = external;
...
public function main() {
    ...
    string[]|error _ = rhsOnly();
    string[]|string _ = bothSides();
    int[] & readonly _ = bothIntersect();
    string[] & readonly _ = outsideIntersection();

    string _ = open(); // @error
    string[3] _ = fixed(); // @error
    var _ = open(); // @error
    float[] _ = constrained(); // @error
    string _ = bothIntersect(); // @error
    string _ = rhsFails(); // @error
}
