...
// A lambda inside a body makes the body start a nested definition span.
function scaled(int amount) returns int {
    var scale = function(int value) returns int {
        return value * LIMIT;
    };
    return scale(amount);
}
