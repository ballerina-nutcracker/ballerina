...
// logRecoveredPanic traces a panic recovered during error recovery, along with its stack
// trace, to the parser's recovery trace.
...
// traceRecovery writes an error-recovery trace message to the token reader's debug output.
