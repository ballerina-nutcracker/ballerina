...
// innermostDiagnosticNodes returns the deepest nodes under node that carry diagnostics, so
// that each diagnostic is reported against the narrowest node it belongs to.
