...
// loc converts a diagnostics location into a bir location, prefixing the file
// path with the context's sourcePrefix when one is set.
...
// GenBirWithSourcePrefix generates the BIR package for ast, prefixing every emitted
// source location's file path with sourcePrefix.
