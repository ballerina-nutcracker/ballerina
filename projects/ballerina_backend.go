...
// already generated by this point (see CompilationOptions.GenerateCode); performCodeGen
// backfills it for any module that opted out.
...
// performCodeGen generates BIR for any module missing it, in topological order.
// generateCodeInternal is idempotent, so this is a no-op where BIR already exists.
